...
#include <memory>
#include "../../../Messenger/Server/chatserver.h"
...
QT_MOC_LITERAL(4, 27, 16), // "UserDisconnected"
QT_MOC_LITERAL(5, 44, 7), // "Worker*"
QT_MOC_LITERAL(6, 52, 6), // "sender"
QT_MOC_LITERAL(7, 59, 12), // "JsonReceived"
QT_MOC_LITERAL(8, 72, 7), // "jsonObj"
QT_MOC_LITERAL(9, 80, 9), // "Broadcast"
QT_MOC_LITERAL(10, 90, 7) // "exclude"

    },
    "ChatServer\0logMessage\0\0msg\0UserDisconnected\0"
    "Worker*\0sender\0JsonReceived\0jsonObj\0"
    "Broadcast\0exclude"
};
...
static const uint qt_meta_data_ChatServer[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 5, QMetaType::QJsonObject,    6,    8,
    QMetaType::Void, QMetaType::QJsonObject, 0x80000000 | 5,    8,   10,
...
void ChatServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->UserDisconnected((*reinterpret_cast< Worker*(*)>(_a[1]))); break;
        case 2: _t->JsonReceived((*reinterpret_cast< Worker*(*)>(_a[1])),(*reinterpret_cast< const QJsonObject(*)>(_a[2]))); break;
        case 3: _t->Broadcast((*reinterpret_cast< const QJsonObject(*)>(_a[1])),(*reinterpret_cast< Worker*(*)>(_a[2]))); break;
        default: ;
        }
